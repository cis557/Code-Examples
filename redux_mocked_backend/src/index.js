...
function AddStudent() {
  ...
  const handleCreateStudent = async (e) => {
    ...
    const storedStudent = await createStudent(newStudent);
    // storedStudent has an id
    // then update state
    store.dispatch(addStudent(storedStudent)); // dispatch action add student to store
  };
