 ...
 * response body
 */
  test('the new student is returned', () => {
    const testStudent = { name: 'testuser', major: 'music', email: 'a@upenn.edu' };
    expect(JSON.parse(response.text).data).toMatchObject(testStudent); // status code
  });
